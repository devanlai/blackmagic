...
#define BOARD_IDENT			"Black Magic Probe (BT), (Firmware " FIRMWARE_VERSION ")"
#define BOARD_IDENT_DFU		"Black Magic (Upgrade), BT, (Firmware " FIRMWARE_VERSION ")"
#define BOARD_IDENT_UPD		"Black Magic (DFU Upgrade), BT, (Firmware " FIRMWARE_VERSION ")"
#define DFU_IDENT			"Black Magic Firmware Upgrade (BT)"
